...
// ============================================================================
// Pup Compatibility Tests
// ============================================================================

#[test]
fn from_html_pup_compat_basic_selectors() {
    let index_html = "tests/data/from_html/pup_compat.html";
...
#[test]
fn from_html_pup_compat_combinators() {
    let index_html = "tests/data/from_html/pup_compat.html";
...
#[test]
fn from_html_pup_compat_attributes() {
    let index_html = "tests/data/from_html/pup_compat.html";
...
#[test]
fn from_html_pup_compat_pseudo_classes() {
    let index_html = "tests/data/from_html/pup_compat.html";
...
#[test]
fn from_html_pup_compat_display_functions() {
    let index_html = "tests/data/from_html/pup_compat.html";
